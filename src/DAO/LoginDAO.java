...
public class LoginDAO {
    ...
    private Usuario buscarUsuarioEnDirectorio(String gmail, String id, String directorio, String tipoUsuario) {
            ...
            for (File archivo : archivos) {
                try (BufferedReader reader = new BufferedReader(new FileReader(archivo))) {
                    ...
                    if (gmail.equalsIgnoreCase(datos.get("email")) && 
                        ...
                        return crearUsuarioSegunTipo(tipoUsuario, datos);
                    }
                } catch (IOException e) {
    ...
    private Map<String, String> extraerDatosUsuario(BufferedReader reader) throws IOException {
        ...
        while ((linea = reader.readLine()) != null) {
            ...
            else if (linea.startsWith("Programa: ")) datos.put("programa", linea.substring(10).trim());
            else if (linea.startsWith("Facultad: ")) datos.put("facultad", linea.substring(10).trim());
            else if (linea.startsWith("Departamento: ")) datos.put("departamento", linea.substring(14).trim());
        }
