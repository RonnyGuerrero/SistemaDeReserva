...
public void registrarEstudiante() {
    ...
    String idOriginal = txtIDestudiante.getText();
    String idEncriptado = Encriptador.encriptarSHA256(idOriginal);
    
    if (idEncriptado == null) {
        JOptionPane.showMessageDialog(this, "Error al encriptar el ID", 
            "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    JOptionPane.showMessageDialog(null, "EStudiante registrado exitosamente", "Exitoso", JOptionPane.INFORMATION_MESSAGE);
...
public void registrarProfesor() {
    ...
    String idOriginal = txtIDprofesor.getText();
    String idEncriptado = Encriptador.encriptarSHA256(idOriginal);
...
public void registrarBienestar() {
    ...
    String idOriginal = txtIDbienestar.getText();
    String idEncriptado = Encriptador.encriptarSHA256(idOriginal);
 ...
 private void login() {
    ...
    if (passwordEncriptado == null) {
        JOptionPane.showMessageDialog(this, "Error en el sistema de autenticación", 
            "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    LoginDAO loginDAO = new LoginDAO();
    Usuario usuario = loginDAO.autenticarUsuario(email, passwordEncriptado);
